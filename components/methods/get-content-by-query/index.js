...
let PostsHandler    = require('../get-previews/PostsHandler');
let UsersHandler    = require('../get-previews/UsersHandler');

let postsHandler = new PostsHandler(true);
let usersHandler = new UsersHandler(true);
